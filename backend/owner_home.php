...
if ($result->num_rows === 0) {
    // User is not owner or doesn't exist
    header("Location: login.php");
    exit();
}
...
<head>
    ...
    <title>Owner Home - Dashboard</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .dashboard-card.donation-card .count {
            color: #374ace;
            font-size: 48px;
        }
...
<body>
    <div class="container">
        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-card" data-card="staff-total" onclick="openDashboard('staff-total')">
                <h3>Total Staff</h3>
                <div class="count" id="staff-total-count"><?php echo $Staff_Total; ?></div>
                <p>Click to view details</p>
            </div>

            <div class="dashboard-card donation-card" data-card="total-donations" onclick="openDashboard('total-donations')">
                <h3>Total Amount Donated</h3>
                <div class="count" id="total-donations-count">₹<?php echo number_format($total_donated, 2); ?></div>
                <p>Click to view details</p>
            </div>
        </div>
    </div>
