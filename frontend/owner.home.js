// Owner Home Dashboard JavaScript
...
function openDashboard(dashboardType) {
    ...
    const routes = {
        ...
        'staff-total': 'staff_total.php',
        'total-donations': 'total_donations.php'
    };
...
function refreshDashboardCounts() {
    fetch('get_owner_dashboard_counts.php')
        ...
        .then(data => {
            ...
            document.getElementById('staff-total-count').textContent = data.staff_total;
            document.getElementById('total-donations-count').textContent = '₹' + parseFloat(data.total_donated).toLocaleString('en-IN', {minimumFractionDigits: 2, maximumFractionDigits: 2});
        })
